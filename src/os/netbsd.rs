...
pub const TIOCM_ST: c_int = 0x00000010;
pub const TIOCM_SR: c_int = 0x00000020;
pub const TIOCM_CTS: c_int = 0x00000040;
pub const TIOCM_CAR: c_int = 0x00000100;
pub const TIOCM_CD: c_int = 0x00000100;
pub const TIOCM_RNG: c_int = 0x00000200;
pub const TIOCM_RI: c_int = 0x00000200;
pub const TIOCM_DSR: c_int = 0x00000400;
